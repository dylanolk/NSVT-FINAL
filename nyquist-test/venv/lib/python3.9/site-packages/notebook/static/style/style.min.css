...
.dynamic-buttons button:focus + [role="tooltip"] {
  visibility: visible;
  opacity: 1;
}
...
[dir="rtl"] .rendered_html:not([dir="ltr"]) p,
.rendered_html[dir="rtl"] p {
  text-align: right;
}
div.text_cell {
  /* Old browsers */
...
ul.dropdown-menu:focus [dir="rtl"] ul.dropdown-menu {
  text-align: right;
  left: auto;
}
